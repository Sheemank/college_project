    ...
    <div>
      ...
      <section className="bg-blue-50 py-20 md:py-32">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-800 mb-4">Find Your Perfect Tutor Today</h1>
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Unlock your potential with expert one-on-one tutoring tailored to your needs.</p>
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto bg-white p-4 rounded-lg shadow-lg flex flex-col md:flex-row gap-4">
            ...
            <input 
              ...
              className="flex-grow p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
            />
            <button type="submit" className="bg-blue-600 text-white px-8 py-3 rounded-md hover:bg-blue-700 transition-colors font-semibold">Search</button>
          </form>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-10">Top Tutors Near You</h2>
          {isLoading ? (
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-10">A Platform Trusted by Students</h2>
      ...
      <section className="py-16 overflow-hidden">
          <div className="container mx-auto">
              <h2 className="text-3xl font-bold text-center text-gray-800 mb-10">Students Speak</h2>
