...
const AvailabilityDisplay: React.FC<AvailabilityDisplayProps> = ({ availability }) => {
  ...
  if (availableDays.length === 0) {
    return <p className="text-gray-500">Not specified, please contact for details.</p>;
  }
  ...
  return (
    <div>
        <div className="flex items-center space-x-4 mb-3 text-sm text-gray-600">
            ...
            <div className="flex items-center"><span className="w-3 h-3 bg-gray-100 rounded-full mr-2 border border-gray-200"></span>Booked</div>
        </div>
        ...
        <table className="min-w-full divide-y divide-gray-200">
            ...
            {availableDays.map(day => {
                ...
                return (
                    <tr key={day}>
                        <td className="px-4 py-3 w-1/3 font-medium text-gray-800 text-sm align-top">{day}</td>
