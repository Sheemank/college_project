    ...
    <footer className="bg-white border-t mt-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold text-blue-600 mb-4">FindMyTutor</h3>
            <p className="text-gray-500 text-sm">Connecting students and tutors, one lesson at a time.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/search" className="text-gray-500 hover:text-blue-600">Find a Tutor</Link></li>
              <li><Link to="/register" className="text-gray-500 hover:text-blue-600">Become a Tutor</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-gray-700 mb-3">Support</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-500 hover:text-blue-600">FAQ</a></li>
              <li><a href="#" className="text-gray-500 hover:text-blue-600">Contact Us</a></li>
